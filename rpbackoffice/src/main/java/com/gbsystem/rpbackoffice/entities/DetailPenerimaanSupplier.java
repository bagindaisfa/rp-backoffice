...
@Entity
public class DetailPenerimaanSupplier {
	@Id
	...
	public PenerimaanSupplier getPenerimaanSupplier() {
		return penerimaanSupplier;
	}
	public void setPenerimaanSupplier(PenerimaanSupplier penerimaanSupplier) {
		this.penerimaanSupplier = penerimaanSupplier;
	}
